...
<table border="0">
	...
	<tr>
		<td>商家名稱</td>
		<td><input type="TEXT" name="store_name" size="45" placeholder="請輸入商家名稱"
			value="<%= (storeVO==null)? "" : storeVO.getStore_name()%>" /></td>
	</tr>
	<tr>
		<td>商家簡介</td>
		<td><textarea name="store_content" size="45" placeholder="請輸入簡介" id="editor1"
			 ></textarea></td>
	</tr>
	<tr>
		<td>商家電話</td>
		<td><input type="TEXT" name="store_phone" size="45" placeholder="請輸入電話"
			value="<%= (storeVO==null)? "" : storeVO.getStore_phone()%>" /></td>
	</tr>
	<tr>
		<td>商家地址</td>
		<td><textarea name="store_addr" size="45" placeholder="請輸入地址"
			 ></textarea></td>
	</tr>
	<tr>
		<td>商家進駐日期</td>
		<td><input type="date" name="store_date" size="45" placeholder="請輸入日期"
			value="<%= (storeVO==null)? "" : storeVO.getStore_date()%>" /></td>
	</tr>	
	<tr>
		<td>商家評價星星數</td>
		<td><input type="number" name="store_star" size="45" placeholder="評價星星數"
			value="<%= (storeVO==null)? "" : storeVO.getStore_star()%>" /></td>
	</tr>
	<tr>
		<td>商家評價次數</td>
		<td><input type="number" name="store_count" size="45" placeholder="評價次數"
			value="<%= (storeVO==null)? "" : storeVO.getStore_count()%>" /></td>
	</tr>
	<tr>
		<td>商家狀態</td>
	...
	<tr>
		<td>商家照片</td>
		<td><input type="file" id="myFile2" name="store_image" /></td>
	</tr>
	<tr>
		<td>商家被檢舉次數</td>
		<td><input type="number" name="store_report_count" size="45" placeholder="商家被檢舉次數"
			value="<%= (storeVO==null)? "" : storeVO.getStore_report_count()%>" /></td>
	</tr>
 	<tr>
		<td>商家停權開始日期</td>
	...
	<tr>
		<td>商家密碼</td>
		<td><input type="password" name="store_pw" size="45" placeholder="請輸入密碼"
			value="<%= (storeVO==null)? "" : storeVO.getStore_pw()%>" /></td>
	</tr>	
	<tr>
		<td>商家帳號</td>
		<td><input type="TEXT" name="store_acc" size="45" placeholder="請輸入帳號"
			value="<%= (storeVO==null)? "" : storeVO.getStore_acc()%>" /></td>
	</tr>	
	<tr>
		<td>商家外送</td>
...
<jsp:include page="listAllStore.jsp" />
<%} %>
