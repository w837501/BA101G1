...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
		<!-- Website CSS style -->
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/backend/assets/css/register.css">
	...
	<body>
		...
		<script type="text/javascript" src="<%=request.getContextPath() %>/backend/assets/js/bootstrap.js"></script>
	</body>
</html>				 
</body>
</html>
