...
<br><br>
<ul>
       <li><a href='<%=request.getContextPath()%>/backend/news/listAllNews.jsp'>List</a> all News </li> <br>

  <li>
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/news/news.do" >
        <b>輸入消息編號 (如NEWS-00001):</b>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/backend/news/addNews.jsp'>新增</a>消息</li>
</ul>                    
