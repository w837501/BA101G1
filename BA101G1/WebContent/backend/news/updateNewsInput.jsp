...
<table class="table table-hover">
	<tr>
		...
		<select size="1" name="man_id">
	 	...
	 	<tr>
		<td>消息編號<font><b>*</b></font></td>
		<td><%=newsVO.getNews_id()%></td>
	</tr> 

	<tr>
		<td>消息標題</td>
		<td><input type="TEXT" name="news_name" size="45"	value="<%=newsVO.getNews_name()%>" /></td>
	</tr>
	<tr>
		<td>消息內文</td>
		<td><input type="TEXT" name="news_content" size="45"	value="<%=newsVO.getNews_content()%>" /></td>
	</tr>

	<tr>
		<td>消息圖片</td>
		<td><input type="file" id="myfile" name="news_image" size="45"	value="<%=newsVO.getNews_image()%>" /></td>
	</tr>	
	<tr>
		<td>消息時間</td>
