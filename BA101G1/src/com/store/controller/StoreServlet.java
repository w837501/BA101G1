...
public class StoreServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		String action = req.getParameter("action");
			...
			// ¨Ó¦Ûindex.jspªº½Ğ¨D			       ¨Ó¦Ûstore.jspªº½Ğ¨D
		if ("get_store".equals(action)) { 
			...
			try {
				...
				if ("get_store_a".equals(action))
					url = "/store/listSearchStore.jsp";     // ¦¨¥\Âà¥æ/store/listSearchStore.jsp
				else if ("get_store_b".equals(action))
					url = "/store.jsp";             		// ¦¨¥\Âà¥æ /store.jsp
				*/
		...
		if ("get_zone".equals(action)) { // ¨Ó¦Ûstore.jspªº½Ğ¨D
		...
		if ("getStoreClass".equals(action)) { // ¨Ó¦ÛstoreClass.jspªº½Ğ¨D
...
=======
		...
		if ("getProduct_By_Store".equals(action)) { // ¨Ó¦ÛstoreClass.jspªº½Ğ¨D
