...
>>>>>>> branch 'ç¬¨' of https://github.com/w837501/BA101G1.git
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getproduct_a".equals(action) || "getproduct_b".equals(action)) { // ¨Ó¦Ûselect_page.jspªº½Ð¨D
		...
		if ("getProductClass".equals(action)) { // ¨Ó¦Ûselect_page.jspªº½Ð¨D
...
>>>>>>> branch 'ç¬¨' of https://github.com/w837501/BA101G1.git
		if ("getOne_In_ShoppingCart".equals(action)) { // ¨Ó¦Ûselect_page.jspªº½Ð¨D
