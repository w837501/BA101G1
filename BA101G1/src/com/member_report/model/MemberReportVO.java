...
public class MemberReportVO implements Serializable{
	...
	private Integer mr_state;
	private Integer mr_result;
	...
	public MemberReportVO(String mr_id, String mem_id, String order_id, String sc_id, String man_id, String mr_content,
			byte[] mr_image, Timestamp mr_time, Integer mr_state, Integer mr_result) {
		super();
		this.mr_id = mr_id;
		this.mem_id = mem_id;
	...
	public Integer getMr_state() {
		return mr_state;
	}

	public void setMr_state(Integer mr_state) {
		this.mr_state = mr_state;
	}

	public Integer getMr_result() {
		return mr_result;
	}

	public void setMr_result(Integer mr_result) {
		this.mr_result = mr_result;
	}
