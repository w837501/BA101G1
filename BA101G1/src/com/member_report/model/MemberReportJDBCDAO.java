...
public class MemberReportJDBCDAO implements MemberReportDAO_interface {
	...
	private static final String INSERT_STMT = 
		"INSERT INTO MEMBER_REPORT (mr_id,mem_id,order_id,sc_id,mr_content,mr_image) VALUES ('MR'||'-'||LPAD(to_char(mr_seq.NEXTVAL),6,'0'), ?, ?, ?, ?, ?)";
	...
	private static final String GET_BY_MEM_ID = "select * from MEMBER_REPORT where mem_id=?";
	@Override
...
//		System.out.println("---------------------");
		...
		// 查詢
		List<MemberReportVO> list = dao.findbyMem_id("MEM-000001");
